...
@Component({
  ...
  templateUrl: './select2-input.component.html',
  styleUrl: './select2-input.component.css'
})
export class Select2Input extends FieldType<FieldTypeConfig> implements OnInit {
  labelKey = 'label';
  valueKey = "value";
