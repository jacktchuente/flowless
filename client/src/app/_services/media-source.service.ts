...
import {MediaSource, MediaSourcePayload, MediaSourceVerifyResponse} from "../_interfaces/media-source";
...
export class MediaSourceApiService extends BaseApiService {
    ...
    verifyCredentials(payload: MediaSourcePayload): Observable<MediaSourceVerifyResponse> {
        return this.http.post<MediaSourceVerifyResponse>(`${this.getFullUrl()}verify/`, payload);
    }
