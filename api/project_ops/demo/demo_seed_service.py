    ...
    def _create_channels(
        ...
        channel_specs = [
            {
                ...
                "editorial": {
                    "allowed": {
                        "categories": ["crime", "drama", "investigation"],
                        "natures": [MediaNature.FICTION],
                        "container_kinds": [MediaContainerKind.SERIES],
                    },
                    "preferred": {"categories": ["crime", "thriller"]},
                    "start_at": time(0, 0),
                    "end_at": time(23, 59),
                    "allow_filler": True,
                },
            ...
            },
            {
                ...
                "editorial": {
                    "allowed": {
                        "categories": ["action", "thriller", "cult"],
                        "natures": [MediaNature.FICTION],
                        "container_kinds": [MediaContainerKind.STANDALONE_VIDEO],
                    },
                    "preferred": {"categories": ["action", "night"]},
                    "start_at": time(20, 0),
                    "end_at": time(2, 0),
                    "allow_filler": True,
                },
            ...
            },
            {
                ...
                "editorial": {
                    "allowed": {
                        "categories": ["current-affairs", "documentary", "analysis"],
                        "natures": [MediaNature.DOCUMENTARY, MediaNature.NEWS],
                        "container_kinds": [MediaContainerKind.SERIES, MediaContainerKind.STANDALONE_VIDEO],
                    },
                    "preferred": {"categories": ["news", "documentary"]},
                    "start_at": time(0, 0),
                    "end_at": time(23, 59),
                    "allow_filler": False,
                },
            ...
            },
            {
                ...
                "editorial": {
                    "allowed": {
                        "categories": ["comedy", "sitcom", "late-night"],
                        "natures": [MediaNature.SHOW],
                        "container_kinds": [MediaContainerKind.SERIES],
                    },
                    "preferred": {"categories": ["comedy", "comfort"]},
                    "start_at": time(18, 30),
                    "end_at": time(23, 30),
                    "allow_filler": True,
                },
            ...
            },
            {
                ...
                "editorial": {
                    "allowed": {
                        "categories": ["music", "live", "concert"],
                        "natures": [MediaNature.MUSIC],
                        "container_kinds": [MediaContainerKind.MUSIC_VIDEO_RELEASE],
                    },
                    "preferred": {"categories": ["music", "session"]},
                    "start_at": time(19, 0),
                    "end_at": time(1, 0),
                    "allow_filler": True,
                },
        ...
        for channel_spec in channel_specs:
            ...
            EditorialLine.objects.create(
                tv_channel=channel,
                allowed=editorial_data.get("allowed", {}),
                preferred=editorial_data.get("preferred", {}),
                forbidden=editorial_data.get("forbidden", {}),
